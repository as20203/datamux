...
const ThingsBoardEditPrompt = (props) => {
    ...
    const onSubmit = (e) =>{
        ...
        const updatedDevice = {Deviceeui:editDevice.deviceUI,Devicetype:editDevice.deviceType,Endpointdest:endPointDest,Endpointtype:endpointType,
                               InclRadio:editDevice.InclRadio,Customer:editDevice.customer,RawData:editDevice.RawData,AccessToken:editDevice.AccessToken,checked:props.rowChecked?true:false}
        props.setData(data=>{
