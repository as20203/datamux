      ...
      {loading?<Loader />:null}
          ...
          <div className='login-container' style={styles.loginContainer}>
            <div className='login-image' style={styles.loginImage}>
                <img onLoad={(e)=>{setLoading(false)}} src='https://www.researchgate.net/profile/Khurshid_Aliev/publication/323258913/figure/fig5/AS:631607719391275@1527598423702/LoRa-star-network-architecture.png' alt='hello' />
            </div>
            {!loading?
