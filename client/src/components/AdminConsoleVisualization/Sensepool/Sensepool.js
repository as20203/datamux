...
//         params: { url: 'https://sensepool.talkpool.com/login' }
//       });
...
//               params: { url: 'https://sensepool.talkpool.com/devices' }
//             });
//         } catch ({ response }) {
//           console.log(response);
//           errorDevices.push({
//             Deviceeui: record.deviceId,
...
//       item =>
//         item.hasOwnProperty('deviceId') &&
//         item.hasOwnProperty('sensorType') &&
//         item.hasOwnProperty('customerGroupId') &&
//         item.hasOwnProperty('deviceName') &&
//         item.hasOwnProperty('deviceDescription') &&
...
//         data => !/((([A-Z]|\d){2}-){7})([A-Z]|\d){2}/.test(data.deviceId)
//       );
...
//             color='primary'
//           >
//             Header Format:deviceId,sensorType,customerGroupId,deviceName,deviceDescription,userId{' '}
//           </Alert>
